...
<div class="w-full rounded-lg bg-slate-900 p-10 text-sm text-indigo-300 sm:w-96 max-w-96 mt-18">
    ...
    <form onSubmit=handleEvent(event)>
        <div class="mb-5 flex gap-3 rounded-full bg-[#333A5c] px-6 py-3">
            ...
            <input type="text" placeholder="Full Name" class="border-none outline-none" required />
        </div>
        <div class="mb-5 flex gap-3 rounded-full bg-[#333A5c] px-6 py-3">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4">
                <path
            ...
            <input type="email" placeholder="Email" class="border-none outline-none" required />
        </div>
        <div class="mb-5 flex gap-3 rounded-full bg-[#333A5c] px-6 py-3">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4">
                <path
            ...
            <input type="password" placeholder="Password" class="border-none outline-none" required />
        </div>
        <button
