...
<div class="container">
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3">Holiday List</h3>
                <h6 class="op-7 mb-2">All Holidays</h6>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
                <a href="{{ route('holidays.create') }}" class="btn btn-primary btn-round">Add Holiday</a>
            </div>
        </div>
        <div class="row">
                                ...
                                <tbody>
                                    @foreach ($holidays as $holiday)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($holiday->to_date)->format('d-M-Y') }}</td>
