                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('leave-types.update', $leaveType->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="leaveName" name="leave_name" value="{{ old('leave_name', $leaveType->leave_name) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="leaveCode" name="leave_code" value="{{ old('leave_code', $leaveType->leave_code) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="totalDays" name="total_days" value="{{ old('total_days', $leaveType->total_days) }}"
